...
- **API docs:** Swagger exposed at `/api-docs` via `swagger.json`.

Create a `.env` file locally with your MongoDB connection string before running the server. See `.env.example`.
